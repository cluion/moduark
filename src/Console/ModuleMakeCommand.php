...
final class ModuleMakeCommand extends Command
{
    ...
    protected $signature = 'moduark:make
        ...
        {type : Maker type: cast, class, controller, enum, event, exception, factory, interface, job, listener, mail, middleware, migration, model, notification, observer, policy, request, resource, rule, scope, seeder, or trait}
